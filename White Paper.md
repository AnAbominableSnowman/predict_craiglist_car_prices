...
## Executive summary
To predict Craigslist ad car prices, I developed a light GBM model. We were able to get an accuracy of $XYZ and explain HDHD% of the variability in Prices with our model. The most important variables were S,S,s,s,d,d,dd,d,d. Future improvments to the model could invovlve better understanding Carvana ads and utizling car images to detect rust.  
