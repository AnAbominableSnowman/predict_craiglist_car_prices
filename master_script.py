from feature_engineering import create_tf_idf_cols,replace_rare_and_null_manufacturer,remove_punc_short_words_lower_case

from load_and_clean_input import drop_unnecessary_columns,unzip_and_load_csv, clean_cylinders_column,switch_condition_to_ordinal,drop_out_impossible_values,fill_missing_values_column_level
from visualization import generate_profiling_report
...
cars_imputed_missing_for_lin_regrs = fill_missing_values_column_level(cars,[
                                              "odometer",
                                              "year",
                                              "manufacturer",
                                              "state",
...
cars_imputed_missing_for_lin_regrs.write_parquet("output/cleaned_input_with_imputed_missing_values_for_linr_regrsn.parquet")
